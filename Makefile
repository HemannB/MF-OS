...
OBJ = boot/boot.o kernel/kernel.o kernel/gdt.o kernel/gdt_flush.o kernel/idt.o kernel/idt_flush.o kernel/pic.o kernel/isr.o kernel/isr_asm.o kernel/timer.o kernel/heap.o kernel/paging.o kernel/process.o kernel/switch.o
